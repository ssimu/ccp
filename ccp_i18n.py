...
M = {
    ...
    "key_help":        ("Enter 실행 · ↑↓/j k 이동 · 숫자 = 번호로 · {other} · Esc/q 취소",
                        "Enter open · ↑↓/j k move · digit = jump · {other} · Esc/q cancel",
                        "Enter 起動 · ↑↓/j k 移動 · 数字 = 番号へ · {other} · Esc/q キャンセル",
                        "Enter 启动 · ↑↓/j k 移动 · 数字 = 跳转 · {other} · Esc/q 取消"),

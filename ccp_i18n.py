...
M = {
    ...
    "z_pick_keys":     ("↑↓ 이동 · 숫자 = 그 번호 · Enter 선택 · Esc/q 취소", "↑↓ move · digit = that number · Enter select · Esc/q cancel",
                        "↑↓ 移動 · 数字 = その番号 · Enter 選択 · Esc/q 取消", "↑↓ 移动 · 数字 = 该编号 · Enter 选择 · Esc/q 取消"),
    "z_pick_new":      ("새 대화", "new conversation", "新しい会話", "新对话"),
    "z_pick_open_mark":("· 이 계정에서 열려 있음", "· open in this account", "· このアカウントで開いている", "· 此账号中已打开"),
    "z_pick_today":    ("오늘", "today", "今日", "今天"),
    "z_pick_week":     ("이번 주", "this week", "今週", "本周"),
    "z_pick_older":    ("이전", "earlier", "以前", "更早"),
    "z_pick_yesterday":("어제", "yesterday", "昨日", "昨天"),
    "z_pick_untitled": ("(제목 없음)", "(untitled)", "(無題)", "(无标题)"),
